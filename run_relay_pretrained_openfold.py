        ...
        for (tag, tags), seqs in sorted_targets:
            ...
            for i in range(args.num_predictions_per_model):
                ...
                unrelaxed_output_path = os.path.join(
                    output_directory, f'{numbered_output_name}{unrelaxed_file_suffix}'
                )
            ...
            logger.info(f"Got a high confidence score of {unrelaxed_models[0][0]} for model {Path(unrelaxed_models[0][2]).stem}")

            if not args.skip_relaxation:
                # Relax the prediction.
                _, unrelaxed_protein, unrelaxed_output_path = unrelaxed_models[0]
